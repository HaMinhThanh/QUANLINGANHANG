...
namespace QLNH
{
    public partial class KiemTraHopDongQuaHan : Form
    {
        private HopDongChoVay selectedHD;
        private HopDongVayBUS busObj;
        public KiemTraHopDongQuaHan()
        {
            busObj = new HopDongVayBUS();
            InitializeComponent();
        }

        private void KiemTraHopDongQuaHan_Load(object sender, EventArgs e)
        {
        ...
        {
            HopDongQuaHanForm newForm = new HopDongQuaHanForm(selectedHD.MaHopDong);
            newForm.Show();
        }
